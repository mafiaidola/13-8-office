...
from routers.enhanced_professional_accounting_routes import router as enhanced_professional_accounting_router
...
app.include_router(basic_compatibility_router)
app.include_router(enhanced_professional_accounting_router)
