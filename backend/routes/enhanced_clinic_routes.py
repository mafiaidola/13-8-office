...
async def get_registration_form_data(
    ...
    try:
        ...
        if not areas and lines:
            ...
            # مناطق للخط الأول
            line1_areas = [
                "منطقة القاهرة الكبرى - الخط الأول",
                "منطقة الجيزة - الخط الأول", 
                "منطقة القليوبية - الخط الأول",
                "منطقة الدقهلية - الخط الأول",
                "منطقة الإسكندرية - الخط الأول"
            ]
            
            # مناطق للخط الثاني
            line2_areas = [
                "منطقة القاهرة الكبرى - الخط الثاني",
                "منطقة الشرقية - الخط الثاني",
                "منطقة كفر الشيخ - الخط الثاني", 
                "منطقة أسيوط - الخط الثاني",
                "منطقة سوهاج - الخط الثاني"
            ]
            
            all_area_names = line1_areas + line2_areas
