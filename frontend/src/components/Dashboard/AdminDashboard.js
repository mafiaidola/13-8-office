      ...
      <div className="bg-white/90 backdrop-blur-sm rounded-xl shadow-sm border border-white/20 p-6">
        <div className="flex justify-between items-center mb-6">
          ...
          <button
            onClick={loadSystemHealth}
            disabled={loading}
            className="flex items-center px-4 py-2 bg-green-50 hover:bg-green-100 text-green-700 rounded-lg border border-green-200 transition-colors"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg p-4 border border-green-200">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-green-800">قاعدة البيانات</p>
          ...
          <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-lg p-4 border border-blue-200">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-blue-800">وقت التشغيل</p>
                <p className="text-2xl font-bold text-blue-600">99.9%</p>
              </div>
              <div className="text-blue-500 text-3xl">⏱️</div>
            </div>
            <p className="text-xs text-blue-600 mt-2">أداء ممتاز</p>
          </div>

          <div className="bg-gradient-to-br from-purple-50 to-violet-50 rounded-lg p-4 border border-purple-200">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-purple-800">الذاكرة</p>
                <p className="text-2xl font-bold text-purple-600">68%</p>
              </div>
              <div className="text-purple-500 text-3xl">💾</div>
            </div>
            <p className="text-xs text-purple-600 mt-2">ضمن الحدود الطبيعية</p>
          </div>

          <div className="bg-gradient-to-br from-orange-50 to-amber-50 rounded-lg p-4 border border-orange-200">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-orange-800">المعالج</p>
                <p className="text-2xl font-bold text-orange-600">45%</p>
              </div>
              <div className="text-orange-500 text-3xl">⚡</div>
            </div>
            <p className="text-xs text-orange-600 mt-2">أداء مثالي</p>
          </div>
        </div>
      </div>
